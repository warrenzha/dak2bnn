...
from dak.models.nnsvgp_variational import NNSVGP

class NNSVGPUCI(object):
    ...
    def model_setup(self):
        ...
        # Initialize inducing points of size [args.num_ip, d], num_ip are # of inducing points, d is dimension
        inducing_points=torch.rand(args.num_ip, feature_extractor.out_features)
